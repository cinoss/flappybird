...
handleTick = function() {
  ...
  switch (status) {
    ...
    case 'play':
      ...
      $('#info').text([Math.round(createjs.Ticker.getMeasuredFPS()), Math.round(createjs.Ticker.getMeasuredTickTime(1))]);
