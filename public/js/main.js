...
var FPS, PipeManager, addMainView, background, bigbang, bird, birdView, building, cloud, config, flap, ground, handleComplete, handleFileLoad, handleProgress, handleTick, init, intro, loadQueue, main, muted, pairs, pipeMan, play, renderBasic, renderShape, scaleMatrix, scaleRatio, stage, startTime, status, theta;
...
main = function() {
  ...
  return createjs.Ticker.setFPS(FPS);
};
